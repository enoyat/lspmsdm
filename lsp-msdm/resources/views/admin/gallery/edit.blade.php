    ...
    <div class="container">
        ...
        <div class="row mt-5 mb-5">
            <div class="col-lg-12 margin-tb">
                ...
                <div class="float-right">
                    <a class="btn btn-secondary" href="{{ route('gallery.index') }}"> Back</a>
                </div>
            </div>
        </div>
        @if ($errors->any())
        ...
        <form action="{{ route('gallery.update', $gallery->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <label for="">File Gambar (JPG, maksimal ukuran file 3MB, kosongkan jika tidak merubah
                            gambar)</label>
                        ...
                        <input type="text" class="form-control" name="filelama" id="filelama"
                            placeholder="Dokumen/Berkas" value="{{ $gallery->gambar }}" readonly="">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <select name="kategori" id="kategori" class="form-control" required>
                            ...
                            <option value="carousel" {{ $gallery->kategori == 'carousel' ? 'selected' : '' }}>carousel
                            </option>
                            <option value="gallery" {{ $gallery->kategori == 'gallery' ? 'selected' : '' }}>gallery</option>
                        </select>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
